...
<br />
<h2 align="center"><font face="Lucida Bright">Object Oriented Programming Language</font></h2>
...
$sql1="select StudentDetails.RollNo,StudentDetails.FirstName,StudentDetails.LastName,Attended.OOPL FROM StudentDetails INNER JOIN Attended ON StudentDetails.RollNo=Attended.RollNo WHERE StudentDetails.Class=(select Class from ClassCoordinator where TID='$t')";
$result1=mysql_query($sql1);
$sql2="select OOPL FROM Lectures WHERE Class=(select Class from ClassCoordinator where TID='$t')";
print "\n";
?>
