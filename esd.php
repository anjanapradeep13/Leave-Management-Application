...
<br />
<h2 align="center"><font face="Lucida Bright">Employment Development Skills</font></h2>
...
$sql1="select StudentDetails.RollNo,StudentDetails.FirstName,StudentDetails.LastName,Attended.ESD FROM StudentDetails INNER JOIN Attended ON StudentDetails.RollNo=Attended.RollNo WHERE StudentDetails.Class=(select Class from ClassCoordinator where TID='$t')";
$result1=mysql_query($sql1);
$sql2="select ESD FROM Lectures WHERE Class=(select Class from ClassCoordinator where TID='$t')";
print "\n";
?>
